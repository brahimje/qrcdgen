...
case '#text':
    $output_data = filter_input(INPUT_POST, "data", FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_NO_ENCODE_QUOTES);
    break;
case '#email':
    $datamailto = filter_input(INPUT_POST, "mailto", FILTER_VALIDATE_EMAIL);
    $datamailsubj = filter_input(INPUT_POST, "subject", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $datamailbody = filter_input(INPUT_POST, "body", FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_NO_ENCODE_QUOTES);
    if ($datamailto) {
...
case '#tel':
    $countrycode = filter_input(INPUT_POST, "countrycodetel", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $number = filter_input(INPUT_POST, "tel", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    if ($number) {
...
case '#sms':
    $countrycode = filter_input(INPUT_POST, "countrycodesms", FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    $number = filter_input(INPUT_POST, "sms", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $bodysms = filter_input(INPUT_POST, "bodysms", FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_NO_ENCODE_QUOTES);
    ...
    break;
case '#whatsapp':
    $countrycode = filter_input(INPUT_POST, "wapp_countrycode", FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    $number = filter_input(INPUT_POST, "wapp_number", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $message = filter_input(INPUT_POST, "wapp_message", FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_NO_ENCODE_QUOTES);
...
case '#skype':
    ...
    $skypetype = filter_input(INPUT_POST, "skypeType", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
...
case '#zoom':
    $zoom_id = filter_input(INPUT_POST, "zoom_id", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $zoom_pwd = filter_input(INPUT_POST, "zoom_pwd", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
...
case '#wifi':
    ...
    $wifipass = filter_input(INPUT_POST, "wifipass", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $networktype = filter_input(INPUT_POST, "networktype", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $wifihidden = filter_input(INPUT_POST, "wifihidden", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
...
case '#location':
    ...
    $lng = filter_input(INPUT_POST, "lng", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    if ($lat && $lng) {
        $output_data = 'geo:'.$lat.','.$lng.'?q='.$lat.','.$lng;
    }
    break;
case '#vcard':
    $vversion     = filter_input(INPUT_POST, "vversion", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $vnametitle = filter_input(INPUT_POST, "vnametitle", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $vname = filter_input(INPUT_POST, "vname", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $vlast = filter_input(INPUT_POST, "vlast", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    $countryphone = filter_input(INPUT_POST, "countrycodevphone", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $countryphone = ($countryphone ? '+'.$countryphone : '');
    $phone        = filter_input(INPUT_POST, "vphone", FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    $countrymobile = filter_input(INPUT_POST, "countrycodevmobile", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $countrymobile = ($countrymobile ? '+'.$countrymobile : '');
    $phoneCell    = filter_input(INPUT_POST, "vmobile", FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    $email        = filter_input(INPUT_POST, "vemail", FILTER_VALIDATE_EMAIL);
    $orgName      = filter_input(INPUT_POST, "vcompany", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $orgTitle     = filter_input(INPUT_POST, "vtitle", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $vurl         = qrcdr()->validateUrl(filter_input(INPUT_POST, "vurl", FILTER_SANITIZE_FULL_SPECIAL_CHARS));

    $countryoffice = filter_input(INPUT_POST, "countrycodevoffice", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $countryoffice = ($countryoffice ? '+'.$countryoffice : '');
    $officephone   = filter_input(INPUT_POST, "vofficephone", FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    $countryfax = filter_input(INPUT_POST, "countrycodevfax", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $countryfax = ($countryfax ? '+'.$countryfax : '');
    $fax        = filter_input(INPUT_POST, "vfax", FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    $address          = filter_input(INPUT_POST, "vaddress", FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_NO_ENCODE_QUOTES);
    $addressTown      = filter_input(INPUT_POST, "vcity", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $addressPostCode  = filter_input(INPUT_POST, "vcap", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $addressCountry   = filter_input(INPUT_POST, "vcountry", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $addressState     = filter_input(INPUT_POST, "vstate", FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    // $vnote = filter_input(INPUT_POST, "vnote", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    break;
case '#paypal':
    $type = filter_input(INPUT_POST, "pp_type", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $email = filter_input(INPUT_POST, "pp_email", FILTER_VALIDATE_EMAIL);
    $name = filter_input(INPUT_POST, "pp_name", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $id = filter_input(INPUT_POST, "pp_id", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $price = filter_input(INPUT_POST, "pp_price", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $currency = filter_input(INPUT_POST, "pp_currency", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $shipping = filter_input(INPUT_POST, "pp_shipping", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $tax = filter_input(INPUT_POST, "pp_tax", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    break;
case '#bitcoin':
    $btc_account = filter_input(INPUT_POST, "btc_account", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $btc_amount = filter_input(INPUT_POST, "btc_amount", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $btc_label = filter_input(INPUT_POST, "btc_label", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $btc_message = filter_input(INPUT_POST, "btc_message", FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_NO_ENCODE_QUOTES);
...
case '#event':
    $title = filter_input(INPUT_POST, "eventtitle", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $location = filter_input(INPUT_POST, "eventlocation", FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_NO_ENCODE_QUOTES);

    $starttime = filter_input(INPUT_POST, "eventstarttime", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $endtime = filter_input(INPUT_POST, "eventendtime", FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    $reminder = filter_input(INPUT_POST, "eventreminder", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $eventurl = qrcdr()->validateUrl(filter_input(INPUT_POST, "eventlink", FILTER_SANITIZE_FULL_SPECIAL_CHARS));
   
    $eventnote = filter_input(INPUT_POST, "eventnote", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
